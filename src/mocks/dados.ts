...
/** Conta de teste do colaborador — mesmo perfil do Marcos, e-mail de teste do cliente. */
export const USUARIO_TESTE_COLABORADOR: Profile = {
  ...USUARIO_ATUAL,
  id: 'user-teste-colaborador',
  nome: 'Colaborador Teste',
  email: 'colaborador@dgtech.com.br',
  onboarding_concluido_em: '2026-07-10T00:00:00Z',
}

/** Conta de teste do admin — vê a área de gestão (/gestao, /admin/conteudo). */
export const USUARIO_TESTE_ADMIN: Profile = {
  id: 'user-teste-admin',
  tenant_id: TENANT_ID,
  nome: 'Admin Teste',
  email: 'admin@dgtech.com.br',
  cargo: 'Administrador',
  setor_id: 'setor-adm',
  foto_url: null,
  papel: 'admin',
...
export const MODULOS: Modulo[] = [
  ...
  { id: 'mod-2', trilha_id: TRILHA.id, numero: 3, titulo: 'Cultura, Missão & Valores', descricao: null, capa_url: '/capas/mod-2.jpg', ordem: 2 },
  {
    ...
    descricao: 'Normas e princípios éticos que orientam o comportamento na DG Tech — playlist com os vídeos reais.',
    capa_url: '/capas/mod-3.jpg',
    ordem: 3,
  },
...
export const AULAS: Aula[] = [
  ...
  // Trilha: Integração DG Tech — playlist do módulo "Código de Conduta" (mod-3)
  { id: 'aula-cond-01', modulo_id: 'mod-3', titulo: 'Código de Conduta 01', descricao: null, panda_video_id: '33442ccf-a2ab-446d-9102-c73b9c4a685a', duracao_seg: 93, ordem: 0 },
  { id: 'aula-cond-03', modulo_id: 'mod-3', titulo: 'Código de Conduta 03', descricao: null, panda_video_id: 'c0b0f21a-be18-4074-b0d9-86ef6d6f6b25', duracao_seg: 276, ordem: 1 },
  { id: 'aula-cond-04c', modulo_id: 'mod-3', titulo: 'Código de Conduta 04c', descricao: null, panda_video_id: 'a032ce2c-57d6-4da8-b90c-750133e4d880', duracao_seg: 163, ordem: 2 },
  { id: 'aula-cond-05', modulo_id: 'mod-3', titulo: 'Código de Conduta 05', descricao: null, panda_video_id: '5e9e58c5-8d22-45f0-a103-2dea2a78a10f', duracao_seg: 52, ordem: 3 },
  { id: 'aula-cond-06', modulo_id: 'mod-3', titulo: 'Código de Conduta 06', descricao: null, panda_video_id: 'ad894feb-7fae-4732-bfd4-3f74aaca0a4a', duracao_seg: 73, ordem: 4 },
  { id: 'aula-cond-07', modulo_id: 'mod-3', titulo: 'Código de Conduta 07', descricao: null, panda_video_id: 'c247fc16-8101-44a2-aad2-ef4536bd9ece', duracao_seg: 105, ordem: 5 },
  { id: 'aula-cond-08', modulo_id: 'mod-3', titulo: 'Código de Conduta 08', descricao: null, panda_video_id: '8c631dfd-c7af-4555-b705-8b1e6801085c', duracao_seg: 130, ordem: 6 },
  { id: 'aula-cond-09', modulo_id: 'mod-3', titulo: 'Código de Conduta 09', descricao: null, panda_video_id: '3c194e4f-7013-4a49-b57e-bcf652478352', duracao_seg: 77, ordem: 7 },
  { id: 'aula-cond-10', modulo_id: 'mod-3', titulo: 'Código de Conduta 10', descricao: null, panda_video_id: '6eb49680-f8b4-40e7-be09-7b21b712d54a', duracao_seg: 146, ordem: 8 },
  { id: 'aula-cond-11', modulo_id: 'mod-3', titulo: 'Código de Conduta 11', descricao: null, panda_video_id: 'a0dc728e-afeb-45ca-a1fa-442911fbaa17', duracao_seg: 121, ordem: 9 },
  { id: 'aula-cond-12', modulo_id: 'mod-3', titulo: 'Código de Conduta 12', descricao: null, panda_video_id: '15967d51-8d24-4527-bb75-504dcb68c42d', duracao_seg: 115, ordem: 10 },
  { id: 'aula-cond-13', modulo_id: 'mod-3', titulo: 'Código de Conduta 13', descricao: null, panda_video_id: '20dae6b2-8db6-4e21-8198-48017d9bc4cb', duracao_seg: 60, ordem: 11 },
  { id: 'aula-cond-14', modulo_id: 'mod-3', titulo: 'Código de Conduta 14', descricao: null, panda_video_id: 'a7212fb3-c721-4254-99e1-58b76c636dc7', duracao_seg: 91, ordem: 12 },
  { id: 'aula-cond-15', modulo_id: 'mod-3', titulo: 'Código de Conduta 15', descricao: null, panda_video_id: 'bd9dd797-3168-4295-b72d-3b516a820ef1', duracao_seg: 98, ordem: 13 },
  { id: 'aula-cond-16', modulo_id: 'mod-3', titulo: 'Código de Conduta 16', descricao: null, panda_video_id: 'c82143fb-708e-489e-8218-797852a52cae', duracao_seg: 57, ordem: 14 },
  { id: 'aula-cond-17', modulo_id: 'mod-3', titulo: 'Código de Conduta 17', descricao: null, panda_video_id: '0dcdcf03-5892-4043-a938-0df332badf34', duracao_seg: 107, ordem: 15 },
  { id: 'aula-cond-18', modulo_id: 'mod-3', titulo: 'Código de Conduta 18', descricao: null, panda_video_id: '2095774d-b2f9-4928-8c83-db4a8bc39e6f', duracao_seg: 151, ordem: 16 },
  { id: 'aula-cond-19', modulo_id: 'mod-3', titulo: 'Código de Conduta 19', descricao: null, panda_video_id: '7a1e45e3-d3af-4d3e-96e1-e55279c34895', duracao_seg: 48, ordem: 17 },
...
export const QUESTOES: Questao[] = [
  ...
  // Trilha: Integração DG Tech — continuação do quiz do módulo "Código de Conduta"
  // (mod-3): q-1/q-2/q-3 acima + estas, consolidadas no fim da playlist de 18
  // vídeos, não por vídeo — mesmo padrão do quiz de "Regras da Casa".
  {
    id: 'q-cond-1', modulo_id: 'mod-3', ordem: 3, pontos: 30,
  ...
  {
    id: 'q-cond-2', modulo_id: 'mod-3', ordem: 4, pontos: 30,
  ...
  {
    id: 'q-cond-3', modulo_id: 'mod-3', ordem: 5, pontos: 30,
  ...
  {
    id: 'q-cond-4', modulo_id: 'mod-3', ordem: 6, pontos: 30,
  ...
  {
    id: 'q-cond-5', modulo_id: 'mod-3', ordem: 7, pontos: 30,
  ...
  {
    id: 'q-cond-6', modulo_id: 'mod-3', ordem: 8, pontos: 30,
  ...
  {
    id: 'q-cond-7', modulo_id: 'mod-3', ordem: 9, pontos: 30,
  ...
  {
    id: 'q-cond-8', modulo_id: 'mod-3', ordem: 10, pontos: 30,
  ...
  {
    id: 'q-cond-9', modulo_id: 'mod-3', ordem: 11, pontos: 30,
